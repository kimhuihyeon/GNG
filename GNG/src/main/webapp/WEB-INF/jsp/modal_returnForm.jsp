...
<form method="post" action="/MODA/returnlist/write">
<input type="hidden" name="MEMBER_NUMBER" value="${sessionScope.MEMBER_NUMBER }">
<input type="hidden" name="ORDER_NUMBER" value="${ORDER_NUMBER }">
<input type="hidden" name="ORDER_CODE" value="${ORDER_CODE}">
<input type="hidden" name="CANCEL_TITLE" value="반품신청합니다.">		<!-- 테스트용으로 넣음 -->
<input type="hidden" name="CANCEL_CATEGORY" value="반품신청">	<!-- 테스트용으로 넣음 -->
