					...
					<div class="row" style="margin-bottom: 5px;">
						<div class="col-sm-6">
							<a href="orderList"><button type="button"
								...
								<option
									value="/MODA/order/orderList?searchNum=1&isSearch=결제대기">결제대기</option>
								<option
									value="/MODA/order/orderList?searchNum=1&isSearch=결제완료">결제완료</option>
								<option
									value="/MODA/order/orderList?searchNum=2&isSearch=구매확정">구매확정</option>
								<option
									value="/MODA/order/orderList?searchNum=2&isSearch=주문취소">주문취소</option>
								<option
									value="/MODA/order/orderList?searchNum=2&isSearch=교환/반품신청">교환/반품신청</option>
								<option
									value="/MODA/order/orderList?searchNum=2&isSearch=처리완료">취소/교환/반품처리완료</option>	
							</select>  <select class="form-control" name="select"
								onchange="window.open(value,'_self');">
								<option value="">--배송상태--</option>
								<option
									value="/MODA/order/orderList?searchNum=3&isSearch=배송준비중">배송준비중</option>
								<option
									value="/MODA/order/orderList?searchNum=3&isSearch=배송중">배송중</option>
								<option
									value="/MODA/order/orderList?searchNum=3&isSearch=배송완료">배송완료</option>
								<option
									value="/MODA/order/orderList?searchNum=3&isSearch=배송취소">배송취소</option>
								<option
									value="/MODA/order/orderList?searchNum=3&isSearch=구매완료">구매완료</option>
