...
<script type="text/javascript">
   function memeberDelete(){
	   var f = document.frm;
	   var MEMBER_NUMBER = f.MEMBER_NUMBER.value;		
	   var pw = f.pw.value;		
	   console.log(MEMBER_NUMBER);
	   console.log(pw);

 	   $.ajax({
		   url: "/MODA/member/deleteMember",
		   type : "post",
		   data: {"MEMBER_NUMBER":MEMBER_NUMBER,"pw":pw},			
		   success:function(data){		
			   if(data == 0){
				   alert("탈퇴되었습니다.");
				   top.location.href= '/MODA/main';
				   self.close();		
			   }
			   else if(data == 1){
				 alert("비밀번호가 틀렸습니다.");
			...
			<div class="list-item">
				...
				<div class="list-item">
					...
					<div class="item-contents hasCol col-xs-24 col-md-18">
						...
						<div class="col-xs-20 col-lg-20 form-inline">
							<input type="password"  name="pw" id="pw" class="form-control" size="28" type="text" required="required"> 
						</div>
					</div>
				</div>
				<!-- list-item//end -->
