			...
			<div class="dataTable_wrapper">
				<div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
					<div class="row" style="margin-bottom: 5px;">
						<div class="col-sm-6">
							<a href="/MODA/notify/adminNotifyList">
					...
					<div class="row">
						<div class="col-sm-12">
							<table class="table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-example" role="grid"
								...
								<tbody>
									<c:forEach var="notifyList" items="${notifyList}" varStatus="stat">
										<c:url var="viewURL" value="/notify/adminNotifyDetail">
											<c:param name="NOTIFY_NUMBER" value="${notifyList.NOTIFY_NUMBER }" />
										</c:url>
										<tr class="gradeA even" role="row">
											<td style="text-align: center; vertical-align: middle;">${notifyList.NOTIFY_NUMBER}</td>
											<td style="text-align: center; vertical-align: middle;">${notifyList.NOTIFY_TITLE}</td>
											<td style="text-align: center; vertical-align: middle;">Admin</td>
											<td style="text-align: center; vertical-align: middle;">
												<fmt:formatDate value="${notifyList.NOTIFY_REGDATE}" pattern="YY.MM.dd HH:mm" />
											</td>
											<td style="text-align: center; vertical-align: middle;">${notifyList.NOTIFY_HITCNT}</td>
											<td style="text-align: center; vertical-align: middle;">
												<a href="${viewURL}">
												...
												<c:url var="viewURL2" value="/notify/adminDeleteNotify">
													<c:param name="NOTIFY_NUMBER" value="${notifyList.NOTIFY_NUMBER }" />
												</c:url> 
												<a href="${viewURL2}">
