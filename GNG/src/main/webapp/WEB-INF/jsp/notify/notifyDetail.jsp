   ...
   <div class="container">
      <div id="page" class="page">
         ...
         <div class="my-account row">
            <section class="col-xs-24 account-navWrap">
               <nav class="account-nav">
                  <ul>
                     <li class="col-xs-8 col-sm-8 selected"><a href="/GNG/notify/notifyList">공지사항</a></li>
                     <li class="col-xs-8 col-sm-8 "><a href="/GNG//faq/faqList">FAQ</a></li>
            ...
            <div class="wrap">
               ...
               <div class="section-body">
                  ...
                  <c:if test="${notifyDetail.NOTIFY_IMAGE ne null}">
                     <img src="/GNG/file/noticeFile/${notifyDetail.NOTIFY_IMAGE}" width="500" class="img-responsive">
                  </c:if>
                  </div>
         ...
         <div class="section-foot">
            <a href="/GNG/notify/notifyList" class="button"><span class="button-label">목록으로</span></a>
         </div>
      </div>
<!--       <script>
