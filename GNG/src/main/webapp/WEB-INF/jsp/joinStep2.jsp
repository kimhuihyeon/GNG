				...
				<section class="col-xs-24 col-sm-12">
					<div class="box-shadow">
						...
						<div class="section-body">
							<textarea class="terms terms2" readonly="readonly">[GNG 회원 약관 ] - 공정거래위원회 표준약관 제 10023호 를 준수합니다.
제1조(목적) 이 약관은 (주)GNG 회사(전자상거래 사업자)가 운영하는 GNG 사이버 몰(이하 “몰”이라 한다)에서 제공하는 
인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.
※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」

제2조(정의)
① “몰”이란 (주)GNG 회사가 재화 또는 용역(이하 “GNG”이라 함)을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 
...
전자우편주소, 사업자등록번호, 통신판매업신고번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 GNG 사이버몰의 
...
$("input[name=MEMBER_ID]").blur(function(){
	...
	var p = $(this).parent();
	$.post("/GNG/checkId",{MEMBER_ID:MEMBER_ID},function(data){
		if (!MEMBER_ID){
				...
				<div class="section-foot">
					...
					function checkSubmit(){
						...
						if(frm.value.length != 8){
							...
							document.frm.action="/GNG/joinComplete";
							document.frm.submit();
						}
					}
					</script>
