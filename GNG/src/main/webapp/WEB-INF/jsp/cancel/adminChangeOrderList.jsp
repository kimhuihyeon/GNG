					...
					<div class="row" style="margin-bottom: 5px;">
						<div class="col-sm-6">
							<a href="exchangeList"><button type="button"
								...
								<option
									value="/MODA/cancel/exchangeList?searchNum=1&isSearch=교환신청">교환신청</option>
								<option
									value="/MODA/cancel/exchangeList?searchNum=1&isSearch=반품신청">반품신청</option>
								<option
									value="/MODA/cancel/exchangeList?searchNum=1&isSearch=교환완료">교환완료</option>
								<option
									value="/MODA/cancel/exchangeList?searchNum=1&isSearch=반품완료">반품완료</option>	
							</select>  <select class="form-control" name="select"
								onchange="window.open(value,'_self');">
								<option value="">--배송상태--</option>
								<option
									value="/MODA/cancel/exchangeList?searchNum=2&isSearch=배송준비중">배송준비중</option>
								<option
									value="/MODA/cancel/exchangeList?searchNum=2&isSearch=배송중">배송중</option>
								<option
									value="/MODA/cancel/exchangeList?searchNum=2&isSearch=배송완료">배송완료</option>
							</select>
						</div>
